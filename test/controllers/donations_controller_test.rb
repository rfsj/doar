...
class DonationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create donation" do
    assert_difference('Donation.count') do
      post donations_url, params: { donation: { description: @donation.description, institution_id: @donation.institution_id, name: @donation.name, need: @donation.need } }
    end
  ...
  test "should update donation" do
    patch donation_url(@donation), params: { donation: { description: @donation.description, institution_id: @donation.institution_id, name: @donation.name, need: @donation.need } }
